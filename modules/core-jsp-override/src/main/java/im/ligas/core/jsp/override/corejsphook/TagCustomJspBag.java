...
package im.ligas.core.jsp.override.corejsphook;
...
@Component(
	immediate = true,
	property = {
		"context.id=TagCustomJspBag", "context.name=Test Custom JSP Bag",
		"service.ranking:Integer=100"
	}
)
public class TagCustomJspBag implements CustomJspBag {
